...
Enfin, le système d'import et de gestion de dépendances, à base de "modules" et de "packages" est difficile à appréhender par un débutant. L'absence d'IDE standard qui règle tous ces problèmes en permettant de lier les projets entre eux rend les choses encore plus difficiles alors qu'elles peuvent être plutôt simples à condition de savoir ce qu'on fait.
...
### Conclusion
J'espère vous avoir donné envie d'installer Python et de découvrir ce langage que j'apprécie énormement, d'abord pour jouer un peu avec, puis si ça vous plaît, vous lancer dans des projets plus complexes. Pour donner une idée, ma dernière appli était un petit proto de retro-engineering de protocole propriétaire - tout pour déclencher l'extraction de vidéos d'un enregistreur et recomposer les vidéos ainsi téléchargées.

Bref ! Python, c'est bon. Mangez-en.
